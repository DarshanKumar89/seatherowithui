...
$(document).ready(function() {
	...
	$("#payment-form").submit(function(event) {
		...
		var cardExpiryMonthAndYear = cardExpiry.split("/");
		if(cardExpiryMonthAndYear.length == 2){
			var expMonth = cardExpiryMonthAndYear[0];
			var expYear = cardExpiryMonthAndYear[1];		
